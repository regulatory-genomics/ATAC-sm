...
setup(
    ...
    url = 'https://github.com/regulatory-genomics/ATAC-sm/tree/main/workflow/scripts/multiqc_atacseq',
    download_url = 'https://github.com/regulatory-genomics/ATAC-sm/tree/main/workflow/scripts/multiqc_atacseq',
    license = 'MIT',
